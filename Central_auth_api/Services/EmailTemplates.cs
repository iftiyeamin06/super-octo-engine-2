...
If you didn't request this, you can safely ignore this email.
    ...
    public static string GetOtpOnlyEmail(string firstName, string otp)
    {
        return $@"<!DOCTYPE html>
<html lang=""en"">
<head>
...
If you didn't request this, you can safely ignore this email. Your password will not be changed.
    ...
    public static string GetMagicLinkEmail(string firstName, string resetLink)
    {
        return $@"<!DOCTYPE html>
<html lang=""en"">
<head>
...
<h1 style=""margin:0 0 8px;color:#18181b;font-size:20px;font-weight:600;text-align:center;"">Reset your password</h1>
<p style=""margin:0 0 24px;color:#71717a;font-size:14px;text-align:center;"">Hi {System.Net.WebUtility.HtmlEncode(firstName)}, click the button below to reset your password.</p>
