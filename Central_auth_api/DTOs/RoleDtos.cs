...
public record RoleCreateDto(string Name, string? Description, long? TenantId, List<long> PermissionIds);
public record RoleUpdateDto(string Name, string? Description, bool IsActive, List<long> PermissionIds);
